...
train_datagen.fit(train_T1)

val_datagen = ImageDataGenerator()

# transform the validation data with statistics from train
# val_T1 -= train_datagen.mean
# val_T1 /= train_datagen.std
...
os.chdir(output_dir)
np.save('T1_history_conv2', history_transfer.history)
model.save('T1_model_conv2.h5')
...
#predict
score = model.evaluate(test_T1,test_1p19q,batch_size=64)
